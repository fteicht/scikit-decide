...
class Requirements {
public:
  typedef std::shared_ptr<Requirements> Ptr;
  ...
  Requirements &
  set_disjunctive_preconditions(bool disjunctive_preconditions = true);
  bool has_disjunctive_preconditions() const;

  Requirements &
  set_existential_preconditions(bool existential_preconditions = true);
  bool has_existential_preconditions() const;

  Requirements &
  set_universal_preconditions(bool universal_preconditions = true);
