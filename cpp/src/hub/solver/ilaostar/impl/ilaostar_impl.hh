...
#define SK_ILAOSTAR_SOLVER_CLASS \
ILAOStarSolver<Tdomain, Texecution_policy>
...
SK_ILAOSTAR_SOLVER_TEMPLATE_DECL
void SK_ILAOSTAR_SOLVER_CLASS::clear() {
    _graph.clear();
}
...
SK_ILAOSTAR_SOLVER_CLASS::StateNode::Key::operator()(const StateNode& sn) const {
    return sn.state;
}
