...
SK_LRTDP_SOLVER_TEMPLATE_DECL
void SK_LRTDP_SOLVER_CLASS::clear() {
    _graph.clear();
}
...
SK_LRTDP_SOLVER_CLASS::greedy_action(StateNode* s, const std::size_t* thread_id) {
...
SK_LRTDP_SOLVER_TEMPLATE_DECL
double SK_LRTDP_SOLVER_CLASS::residual(StateNode* s, const std::size_t* thread_id) {
    s->best_action = greedy_action(s, thread_id);
...
SK_LRTDP_SOLVER_TEMPLATE_DECL
void SK_LRTDP_SOLVER_CLASS::trial(StateNode* s,
                                  const std::chrono::time_point<std::chrono::high_resolution_clock>& start_time,
                                  const std::size_t* thread_id) {
...
SK_LRTDP_SOLVER_TEMPLATE_DECL
void SK_LRTDP_SOLVER_CLASS::compute_reachable_subgraph(StateNode* node, std::unordered_set<StateNode*>& subgraph) {
...
SK_LRTDP_SOLVER_TEMPLATE_DECL
void SK_LRTDP_SOLVER_CLASS::remove_subgraph(std::unordered_set<StateNode*>& root_subgraph, std::unordered_set<StateNode*>& child_subgraph) {
