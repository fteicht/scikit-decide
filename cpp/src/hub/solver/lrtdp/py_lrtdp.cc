...
void init_pylrtdp(py::module& m) {
    py::class_<skdecide::PyLRTDPSolver> py_lrtdp_solver(m, "_LRTDPSolver_");
        py_lrtdp_solver
            ...
            .def("get_next_action", &skdecide::PyLRTDPSolver::get_next_action, py::arg("state"))
            .def("get_utility", &skdecide::PyLRTDPSolver::get_utility, py::arg("state"))
            .def("get_nb_of_explored_states", &skdecide::PyLRTDPSolver::get_nb_of_explored_states)
