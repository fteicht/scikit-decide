 ...
 */
#ifndef SKDECIDE_PY_AOSTAR_HH
#define SKDECIDE_PY_AOSTAR_HH
...
using PyAOStarDomain = PythonDomainProxy<Texecution>;
    ...
    PyAOStarSolver(py::object& domain,
        ...
        TemplateInstantiator::select(
            ...
            SolverInstantiator(_implementation)).instantiate(
                domain, goal_checker, heuristic, discount,
                max_tip_expansions, detect_cycles, debug_logs);
