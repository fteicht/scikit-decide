...
void init_pymcts(py::module& m) {
    ...
    py::enum_<skdecide::PyMCTSOptions::TransitionMode>(py_mcts_options, "TransitionMode")
        .value("Step", skdecide::PyMCTSOptions::TransitionMode::Step)
        .value("Sample", skdecide::PyMCTSOptions::TransitionMode::Sample)
        .value("Distribution", skdecide::PyMCTSOptions::TransitionMode::Distribution);
    ...
    py::class_<skdecide::PyMCTSSolver> py_mcts_solver(m, "_MCTSSolver_");
        py_mcts_solver
            .def(py::init<py::object&,
                          ...
                          double,
                          double,
                          skdecide::PyMCTSOptions::TransitionMode,
                          ...
                          skdecide::PyMCTSOptions::BackPropagator,
                          bool,
                          bool,
                 ...
                 py::arg("transition_mode")=skdecide::PyMCTSOptions::TransitionMode::Distribution,
                 py::arg("tree_policy")=skdecide::PyMCTSOptions::TreePolicy::Default,
                 py::arg("expander")=skdecide::PyMCTSOptions::Expander::Full,
                 py::arg("action_selector_optimization")=skdecide::PyMCTSOptions::ActionSelector::UCB1,
                 py::arg("action_selector_execution")=skdecide::PyMCTSOptions::ActionSelector::BestQValue,
                 py::arg("rollout_policy")=skdecide::PyMCTSOptions::RolloutPolicy::Random,
                 py::arg("back_propagator")=skdecide::PyMCTSOptions::BackPropagator::Graph,
            ...
            .def("get_next_action", &skdecide::PyMCTSSolver::get_next_action, py::arg("state"))
            .def("get_utility", &skdecide::PyMCTSSolver::get_utility, py::arg("state"))
            .def("get_nb_of_explored_states", &skdecide::PyMCTSSolver::get_nb_of_explored_states)
