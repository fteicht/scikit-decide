...
template <typename Rule> struct tracer : normal<Rule> {
  ...
  static void start(const Input &in, trace_state &ts, States &&...st) {
    ...
    o << in.position() << "  start  " << demangle<Rule>() << "; current ";
    print_current(in, o);
    spdlog::debug(o.str());
  ...
  static void success(const Input &in, trace_state &ts, States &&...st) {
    ...
    o << std::setw(6) << ++ts.line << " " << std::setw(6) << ts.stack.back()
      << " ";
    o << in.position() << " success " << demangle<Rule>() << "; next ";
    print_current(in, o);
    spdlog::debug(o.str());
    ts.stack.pop_back();
  }
  ...
  static void failure(const Input &in, trace_state &ts, States &&...st) {
    ...
    o << std::setw(6) << ++ts.line << " " << std::setw(6) << ts.stack.back()
      << " ";
    o << in.position() << " failure " << demangle<Rule>();
    spdlog::debug(o.str());
    ts.stack.pop_back();
  }
  ...
  static auto apply(const Iterator &begin, const Input &in, trace_state &ts,
    ...
    o << in.position() << "  apply  " << demangle<Rule>();
    spdlog::debug(o.str());
  ...
  static auto apply0(const Input &in, trace_state &ts, States &&...st)
    ...
    std::ostringstream o;
    o << std::setw(6) << ++ts.line << "        ";
    o << in.position() << "  apply0 " << demangle<Rule>();
    spdlog::debug(o.str());
