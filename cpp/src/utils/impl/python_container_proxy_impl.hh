...
template <typename Texecution>
PythonContainerProxy<Texecution>::value_type::value_type(const py::object& value) {
    _value = std::make_unique<ObjectType>(value);
}

template <typename Texecution>
PythonContainerProxy<Texecution>::value_type::value_type(const value_type& other) {
    other._value->copy(_value);
}

template <typename Texecution>
typename PythonContainerProxy<Texecution>::value_type&
PythonContainerProxy<Texecution>::value_type::operator= (const value_type& other) {
    other._value->copy(_value);
    return *this;
}
...
template <typename Texecution>
template <typename T>
PythonContainerProxy<Texecution>::value_type::PrimitiveType<T>::PrimitiveType(const T& value)
: _value(value) {}
...
template <typename Texecution>
template <typename T>
void PythonContainerProxy<Texecution>::value_type::PrimitiveType<T>::copy(std::unique_ptr<BaseType>& other) const {
    other = std::make_unique<PrimitiveType<T>>(_value);
}

template <typename Texecution>
template <typename T>
std::size_t PythonContainerProxy<Texecution>::value_type::PrimitiveType<T>::hash() const {
    return boost::hash_value(_value);
}

template <typename Texecution>
template <typename T>
bool PythonContainerProxy<Texecution>::value_type::PrimitiveType<T>::equal(const BaseType& other) const {
...
template <typename Texecution>
PythonContainerProxy<Texecution>::value_type::ObjectType::ObjectType(const py::object& value) {
...
template <typename Texecution>
void PythonContainerProxy<Texecution>::value_type::ObjectType::copy(std::unique_ptr<BaseType>& other) const {
    other = std::make_unique<ObjectType>(*_value);
}

template <typename Texecution>
std::size_t PythonContainerProxy<Texecution>::value_type::ObjectType::hash() const {
    typename GilControl<Texecution>::Acquire acquire;
    try {
...
template <typename Texecution>
bool PythonContainerProxy<Texecution>::value_type::ObjectType::equal(const BaseType& other) const {
    typename GilControl<Texecution>::Acquire acquire;
    try {
...
template <typename Texecution>
PythonContainerProxy<Texecution>::PythonContainerProxy(const py::object& vector) {
    typename GilControl<Texecution>::Acquire acquire;
...
template <typename Texecution>
bool PythonContainerProxy<Texecution>::BaseImplementation::equal(const BaseImplementation& other) const {
...
PythonContainerProxy<Texecution>::SequenceImplementation<Tsequence>::SequenceImplementation(const py::object& vector) {
    typename GilControl<Texecution>::Acquire acquire;
...
template <typename Texecution>
template <typename Tsequence>
PythonContainerProxy<Texecution>::SequenceImplementation<Tsequence>::SequenceImplementation(const SequenceImplementation& other) {
    typename GilControl<Texecution>::Acquire acquire;
...
template <typename Texecution>
template <typename Tsequence>
PythonContainerProxy<Texecution>::SequenceImplementation<Tsequence>::~SequenceImplementation() {
    typename GilControl<Texecution>::Acquire acquire;
    _vector.reset();
}
...
template <typename Texecution>
template <typename Tsequence>
std::size_t PythonContainerProxy<Texecution>::SequenceImplementation<Tsequence>::size() const {
    typename GilControl<Texecution>::Acquire acquire;
    return _vector->size();
}
...
template <typename Tsequence>
typename PythonContainerProxy<Texecution>::value_type
PythonContainerProxy<Texecution>::SequenceImplementation<Tsequence>::at(std::size_t index) const {
    typename GilControl<Texecution>::Acquire acquire;
...
template <typename Texecution>
template <typename Tsequence>
bool PythonContainerProxy<Texecution>::SequenceImplementation<Tsequence>::same_type(const BaseImplementation& other) const {
...
template <typename Texecution>
template <typename T>
PythonContainerProxy<Texecution>::NumpyImplementation<T>::NumpyImplementation(const py::object& vector) {
    typename GilControl<Texecution>::Acquire acquire;
...
template <typename Texecution>
template <typename T>
PythonContainerProxy<Texecution>::NumpyImplementation<T>::NumpyImplementation(const NumpyImplementation& other) {
    typename GilControl<Texecution>::Acquire acquire;
...
template <typename Texecution>
template <typename T>
std::size_t PythonContainerProxy<Texecution>::NumpyImplementation<T>::size() const {
    typename GilControl<Texecution>::Acquire acquire;
    return _vector->size();
}
...
template <typename T>
typename PythonContainerProxy<Texecution>::value_type
PythonContainerProxy<Texecution>::NumpyImplementation<T>::at(std::size_t index) const {
    typename GilControl<Texecution>::Acquire acquire;
